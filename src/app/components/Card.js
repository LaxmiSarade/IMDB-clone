...
const Card = ({ result }) => {
  return (
    <div
      className="cursor-pointer sm:p-3 sm:hover:shadow-slate-400 sm:shadow-md rounded-lg sm:border sm:border-slate-400 group
      ...
      <Link href={`/movie/${result.id}`}>
        ...
        <div className="p-2">
          ...
          <p className="flex items-center">
            ...
            <FaHeart className="text-red-500 ml-3 mr-1" />
            {result.vote_count}
          </p>
        </div>
      </Link>
